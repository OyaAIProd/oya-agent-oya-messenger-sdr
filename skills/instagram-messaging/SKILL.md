...
description: "Send and receive Instagram direct messages, manage conversations, and prospect via Instagram DMs"
category: messaging
icon: message-circle
skill_type: sandbox
...
tool_schema:
  ...
  description: "Send and receive Instagram direct messages, manage conversations, and start new DMs"
  parameters:
    type: object
    properties:
      action:
      ...
      attendees_ids:
        type: "string"
        description: "Comma-separated Instagram user IDs for start_chat"
        default: ""
      limit:
        type: "integer"
...
Send and receive Instagram direct messages via the Unipile messaging API.

## Conversations
- **list_chats** -- List recent Instagram DM conversations.
...
- **send_message** -- Send a DM in an existing conversation. Provide `chat_id` and `text`.

## Outreach
- **start_chat** -- Start a new DM conversation. Provide `attendees_ids` (Instagram user ID) and `text`.
